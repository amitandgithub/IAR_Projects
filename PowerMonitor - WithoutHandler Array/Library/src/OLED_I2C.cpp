...
OLED::OLED( Bsp::I2CDriver* pI2CDriver): m_pI2CDriver(pI2CDriver)
{ 
...
void OLED::begin()
{
  /*
    ...
    _sendTWIcommand(0x14);// 0x10 if SSD1306_EXTERNALVCC 
    ...
    _sendTWIcommand(0x02);//0x12
    _sendTWIcommand(SSD1306_SET_CONTRAST_CONTROL);
    _sendTWIcommand(0x8F);//0xCF
    // End 128x32
    _sendTWIcommand(SSD1306_SET_PRECHARGE_PERIOD);
    _sendTWIcommand(0xF1);// 0x22 if SSD1306_EXTERNALVCC
...
void OLED::update()
{
    uint8_t Lvalue = SSD1306_DATA_CONTINUE;
	//noInterrupts();
