...
namespace Peripherals
{
    ...
    public:
        ...
        inline void On(void){HAL_GPIO_WritePin(m_Port, m_Pin,(GPIO_PinState)1);}
        
        inline void Off(void){HAL_GPIO_WritePin(m_Port, m_Pin, (GPIO_PinState)0);}
        ...
        inline void ToggleOutput(void){HAL_GPIO_TogglePin(m_Port,m_Pin);}
