...
RotaryEncoderPoll::RotaryEncoderPoll(Pin_t CWPin,Pin_t CCWPin,Pin_t SWPin,
        ...
        _CCW(CCWPin,BSP::BtnPoll::BTN_PULL_DOWN,10),
        _SW(SWPin,BSP::BtnPoll::BTN_PULL_DOWN,0,SWH2LCallback,SWL2HCallback), // for CCW Debounce time for 8 ~ 10 msec works fine + 100nf and 1K RC debounce
        _CWCurrState(0),
