...
Peripherals::GpioOutput      CS(GPIOB,GPIO_PIN_1);
Peripherals::SPI_DMA         SPI_Obj(Peripherals::SPI_Base::SPI1_A4_A5_A6_A7,&CS,LCD_SPI_FREQ );
Peripherals::GpioOutput      D_C(GPIOB,GPIO_PIN_0);
Peripherals::GpioOutput      Backlight(GPIOA,GPIO_PIN_0);
Peripherals::GpioOutput      Reset(GPIOB,GPIO_PIN_10);
Peripherals::Nokia5110LCD    LCD(&SPI_Obj,&CS,&D_C,&Reset,&Backlight);



/* Globals for Touch Button task*/
Peripherals::HwButton HwButton_A8(GPIOB, GPIO_PIN_9);
