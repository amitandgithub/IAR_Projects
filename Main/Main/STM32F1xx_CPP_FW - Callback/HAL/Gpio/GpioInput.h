...
public:
    ...
    GpioInput(Pin_t  Pin, GpioInput_Params_t Params = INPUT_PULL_UP , Intr_Event_Edge_t Edge = IT_ON_FALLING, CallbackFunction cb = nullptr);
    ...
    static inline void connectCallback(CallbackFunction cb);
...
void GpioInput::connectCallback(CallbackFunction cb)
{
    m_callback = cb;
}
