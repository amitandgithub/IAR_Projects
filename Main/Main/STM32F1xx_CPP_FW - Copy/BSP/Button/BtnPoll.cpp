...
BtnPoll::BtnPoll(Pin_t Pin, Pull_t Pull, uint8_t Debounce,  HALCallback_t L2HCallback, HALCallback_t H2LCallback) :
        _BtnPin(Pin,(Pull==BTN_PULL_UP?HAL::GpioInput::INPUT_PULL_UP:HAL::GpioInput::INPUT_PULL_DOWN),HAL::GpioInput::IT_ON_FALLING,makeFunctor((CBFunctor0*)0,*this,&BtnPoll::Rise) ),
        _debounce(Debounce),
