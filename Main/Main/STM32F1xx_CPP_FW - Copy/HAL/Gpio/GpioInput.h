...
public:
    ...
    GpioInput(Pin_t  Pin, GpioInput_Params_t Params = INPUT_PULL_UP , Intr_Event_Edge_t Edge = IT_ON_FALLING, const CBFunctor0 &uponClickDoThis = nullptr);
