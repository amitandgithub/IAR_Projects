...
GpioInput::GpioInput(Pin_t  Pin, GpioInput_Params_t Params,Intr_Event_Edge_t Edge, const CBFunctor0 &uponClickDoThis) : Gpio(Pin), _params(Params), _Intr_Event_Edge(Edge), _pISR(nullptr)
{
...
bool GpioInput::Read(GpioInput* thisPtr)
{
