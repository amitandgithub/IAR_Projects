...
INA219::INA219(I2C_t* pI2CDrv, uint8_t INA219Address)
{
	m_pI2CDrv = pI2CDrv;
...
uint32_t INA219::Xfer(uint8_t *pTxBuf, uint16_t TxLen, uint8_t *pRxBuf, uint16_t RxLen)
{
   return m_pI2CDrv->Xfer(INA219_ADDR, pTxBuf, TxLen, pRxBuf, RxLen);
}
