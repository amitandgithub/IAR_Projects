...
{    
   ...
   // Interrupt::RegisterInterrupt(Interrupt::I2C1_EV_IRQHandler); 
    //Interrupt::RegisterInterrupt(Interrupt::I2C1_ER_IRQHandler);
    Peripherals::Interrupt::RegisterInterrupt_Vct_Table(I2C_EV_ISR,static_cast<Peripherals::Interrupt::IRQn>(I2C1_EV_IRQHandler));
    Peripherals::Interrupt::RegisterInterrupt_Vct_Table(I2C_ER_ISR,static_cast<Peripherals::Interrupt::IRQn>(I2C1_ER_IRQHandler));
    return 0;
}
...
void I2C_Slave::I2C_EV_ISR(void)
{
    HAL_I2C_EV_IRQHandler(&Peripherals::I2C_Slave::m_hi2c);
}  
void I2C_Slave::I2C_ER_ISR(void)
{
...
extern "C"
{
extern Peripherals::GpioOutput LED;
